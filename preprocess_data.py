...
def preprocessing():
	image_captions = open("C:/Users/ritik/Desktop/minor2/Flickr8K_Text/Flickr8k.token.txt").read().split('\n')
	caption = {}
	...
	train_imgs_id = open("C:/Users/ritik/Desktop/minor2/Flickr8K_Text/Flickr_8k.trainImages.txt").read().split('\n')[:-1]

	
	train_imgs_captions = open("C:/Users/ritik/Desktop/minor2/Flickr8K_Text/trainimgs.txt",'w')
	...
	test_imgs_id = open("C:/Users/ritik/Desktop/minor2/Flickr8K_Text/Flickr_8k.testImages.txt").read().split('\n')[:-1]

	test_imgs_captions = open("C:/Users/ritik/Desktop/minor2/Flickr8K_Text/testimgs.txt",'w')
